...
*
* Template for Remository Configuration - Intro
*/
	...
	{$this->fileInputAreaconfig(_DOWN_MAIN_PREAMBLE, '', 'preamble', $this->repository->preamble, 50, 100, true)}
	...
	<div>
		...
		<input type="hidden" name="configpage" value="intro" />
	</div>
	</form>
	</div></div>
