...
// Remository 3.47 Espa�ol ANSI
// Traducci�n corregida y completada por Hefesto - http://www.gnumla.com - Marzo 2009
// Remository 3.55.J2 Espa�ol ANSI
// Traducci�n completada por Euskalweb - http://www.euskalweb.net - octubre 2012
...
if (!defined('_DOWN_CONFIRM_MSG')) DEFINE('_DOWN_CONFIRM_MSG','�Quieres ir m�s all�?');
if (!defined('_DOWN_RENAME')) DEFINE('_DOWN_RENAME','Renombrar');
if (!defined('_DOWN_CONTAINER_RENAME_INSTRUCTION')) DEFINE('_DOWN_CONTAINER_RENAME_INSTRUCTION','Importante: si modifica el nombre de la carpeta, no cambiar� su carpeta f�sica. Renombrar el nombre de carpetas f�sicas, s�lo est� disponible en backoffice.');
if (!defined('_DOWN_CONTAINER_DELETE_NOT_EMPTY')) DEFINE('_DOWN_CONTAINER_DELETE_NOT_EMPTY','Cuidado, esta categor�a no est� vac�a. Todos los archivos y subcategor�as tambi�n se eliminar�n.');
if (!defined('_DOWN_CONTAINER_DELETE_INVALID_GROUP')) DEFINE('_DOWN_CONTAINER_DELETE_INVALID_GROUP','Usted no tiene derechos de borrado en esta categor�a');
if (!defined('_DOWN_CONTAINER_UPDATE_INVALID_GROUP')) DEFINE('_DOWN_CONTAINER_UPDATE_INVALID_GROUP','Usted no tiene derechos de edici�n en esta categor�a.');
if (!defined('_DOWN_SUBCONTAINER_CREATE_LABEL')) DEFINE('_DOWN_SUBCONTAINER_CREATE_LABEL','A�adir una subcategor�a');
if (!defined('_DOWN_SUBCONTAINER_CREATE_INVALID_GROUP')) DEFINE('_DOWN_SUBCONTAINER_CREATE_INVALID_GROUP','Usted no tiene derechos para crear subcategor�as en esta categor�a.');
if (!defined('_DOWN_SUBCONTAINER_CREATE_ERR_TITLE')) DEFINE('_DOWN_SUBCONTAINER_CREATE_ERR_TITLE', 'La categor�a no se puede crear');
if (!defined('_DOWN_SUBCONTAINER_CREATE_FOLDER_WARN01')) DEFINE('_DOWN_SUBCONTAINER_CREATE_FOLDER_WARN01','El t�tulo elegido no es v�lido: no hay ninguna carpeta f�sica, que pueda ser creada a partir de la misma.');
if (!defined('_DOWN_SUBCONTAINER_CREATE_FOLDER_ERR01')) DEFINE('_DOWN_SUBCONTAINER_CREATE_FOLDER_ERR01','La carpeta f�sica no se puede crear: carpeta principal de la categor�a f�sica no se puede encontrar.');
if (!defined('_DOWN_SUBCONTAINER_CREATE_FOLDER_ERR02')) DEFINE('_DOWN_SUBCONTAINER_CREATE_FOLDER_ERR02','La carpeta f�sica no se puede crear: por favor compruebe los permisos de las carpetas f�sicas.');
if (!defined('_DOWN_CONFIG_TITLE_FRONT_OFFICE_MGT')) DEFINE('_DOWN_CONFIG_TITLE_FRONT_OFFICE_MGT','Administraci�n del Front office');
if (!defined('_DOWN_CONFIG_TITLE_RIGHTS')) DEFINE('_DOWN_CONFIG_TITLE_RIGHTS','Gesti�n de permisos');
if (!defined('_DOWN_CONFIG_TITLE_DISPLAY')) DEFINE('_DOWN_CONFIG_TITLE_DISPLAY','Pantalla de gesti�n');
if (!defined('_DOWN_CONFIG108')) DEFINE ('_DOWN_CONFIG108', '<b>Permitir editar categor�as:</b> <br/><em>(Permitir a los usuarios editar (en este caso, basta con cambiar el nombre del t�tulo) las categor�as para las que tienen permisos para subir archivos)</em>');
if (!defined('_DOWN_CONFIG107')) DEFINE ('_DOWN_CONFIG107', '<b>Permitir borrar categor�as: </b><br /><em>(Permitir a los usuarios eliminar las categor�as qpara las que tienen permisos para subir archivos)</em>');
if (!defined('_DOWN_CONFIG106')) DEFINE ('_DOWN_CONFIG106', '<b>Permitir agregar subcategor�as: </b><br /><em>(Permitir a los usuarios agregar subcategor�as en las categor�as para las que tienen permisos para subir archivos)</em>');

// Additions in 3.53+
if (!defined('_DOWN_UPLOAD_NEW_FOLDER')) DEFINE ('_DOWN_UPLOAD_NEW_FOLDER', 'Crear carpeta bajo la carpeta seleccionada:');
if (!defined('_DOWN_EMAIL_NOTIFY_PREFIX')) DEFINE ('_DOWN_EMAIL_NOTIFY_PREFIX', 'Los siguientes archivos pueden ser de su inter�s:');
if (!defined('_DOWN_EMAIL_NOTIFY_POSTFIX')) DEFINE ('_DOWN_EMAIL_NOTIFY_POSTFIX', 'Si usted tiene preguntas sobre el archivo superior, por favor p�ngase en contacto con el remitente.');
if (!defined('_DOWN_COULD_NOT_SEND')) DEFINE ('_DOWN_COULD_NOT_SEND', 'No se pudo enviar %s a %s, no se permite.');
if (!defined('_DOWN_EMAIL_NOTIFY')) DEFINE ('_DOWN_EMAIL_NOTIFY', 'Me gustar�a notificarle de %s y se la puede descargar en %s');
if (!defined('_DOWN_ATTEMPTING_MAIL')) DEFINE ('_DOWN_ATTEMPTING_MAIL', 'Intento de correo %s con %s');
if (!defined('_DOWN_LINKS_TO_FILES')) DEFINE ('_DOWN_LINKS_TO_FILES', 'Enlaces a archivos de inter�s');
if (!defined('_DOWN_EMAIL_SUCCESSFUL')) DEFINE ('_DOWN_EMAIL_SUCCESSFUL', 'Email enviado con �xito a %s');
if (!defined('_DOWN_EMAIL_FAILED')) DEFINE ('_DOWN_EMAIL_FAILED', 'El Intento de enviar un correo electr�nico a %s al email %s fall�');
if (!defined('_DOWN_NOTHING_TO_DO')) DEFINE ('_DOWN_NOTHING_TO_DO', 'Nada que hacer');

// Additions in 3.53
if (!defined('_DOWN_ALL_CATEGORIES')) DEFINE ('_DOWN_ALL_CATEGORIES', 'Todas las categor�as');
if (!defined('_DOWN_THANKS_FOR_VOTING')) DEFINE ('_DOWN_THANKS_FOR_VOTING', 'Gracias por votar');
if (!defined('_DOWN_CAST_YOUR_VOTE')) DEFINE ('_DOWN_CAST_YOUR_VOTE', '�Por qu� no emitir su voto?');
...
if (!defined('_DOWN_UPLOAD_BLOCKED_GROUPS')) DEFINE ('_DOWN_UPLOAD_BLOCKED_GROUPS', 'Lo siento, no est� autorizado para subir archivos en la actualidad.');
if (!defined('_DOWN_NO_REMOSITORY_GROUPS')) DEFINE ('_DOWN_NO_REMOSITORY_GROUPS', 'Los permisos de grupo de Remository no est�n disponibles - Configuraci�n dice que use los permisos de grupo del CMS');
if (!defined('_DOWN_POSSIBLE_DUPLICATE_NAMES')) DEFINE ('_DOWN_POSSIBLE_DUPLICATE_NAMES', 'Configuraci�n guardada, pero es necesaria la ID de archivo debido a los nombres de archivos duplicados');
if (!defined('_DOWN_CONFIG105')) DEFINE ('_DOWN_CONFIG105', '<b>Desactivar la acci�n por defecto del navegador para la apertura de un archivo descargado.</b></em>');
...
if (!defined('_DOWN_CONFIG103')) DEFINE ('_DOWN_CONFIG103', '<b>Descarga inmediata: </b><br /><em>(Saltar p�gina de informaci�n de archivo, ir directamente a la descarga.)</em>');
if (!defined('_DOWN_CONFIG72')) DEFINE ('_DOWN_CONFIG72', '<b>Nombre Real con ID: </b><br /><em>(Los actuales nombres de los archivos en el disco, se har�n �nicos, mediante la inserci�n de n�mero ID de archivo.)</em>');
if (!defined('_DOWN_DETAILS')) DEFINE('_DOWN_DETAILS','Detalles');
if (!defined('_DOWN_THIS_FILE_TODAY')) DEFINE ('_DOWN_THIS_FILE_TODAY', 'Usted ha descargado este archivo %d veces en las �ltimas 24 horas; el l�mite es %d.');
if (!defined('_DOWN_ALL_FILES_TODAY')) DEFINE ('_DOWN_ALL_FILES_TODAY', 'Sus descargas de archivos en total han sido %d en las �ltimas 24 horas; el l�mite es %d.');
if (!defined('_DOWN_YOUR_CREDITS')) DEFINE ('_DOWN_YOUR_CREDITS', 'Actualmente tiene %d cr�ditos disponibles.');
if (!defined('_DOWN_TOO_FEW_CREDITS')) DEFINE ('_DOWN_TOO_FEW_CREDITS', '�No tien suficientes cr�ditos para descargar!');
if (!defined('_DOWN_CONFIG71')) DEFINE ('_DOWN_CONFIG71', '<b>Mostrar Subcategor�as: </b><br /><em>(Mostrar categor�as hijo, bajo categor�as padre.)</em>');
if (!defined('_DOWN_PRICE_LABEL')) DEFINE ('_DOWN_PRICE_LABEL', 'Precio:');

// Additions in 3.52
if (!defined('_DOWN_MANY_CONTAINERS')) DEFINE('_DOWN_MANY_CONTAINERS', 'Demasiados contenedores para la lista - por favor navegue a trav�s de los enlaces de contenedores �');
if (!defined('_DOWN_DELETE_SURE')) DEFINE ('_DOWN_DELETE_SURE', '�Est� seguro que quieres eliminar este archivo?');
if (!defined('_DOWN_SEARCH_CATEGORY_SELECT')) DEFINE ('_DOWN_SEARCH_CATEGORY_SELECT', 'Elija las categor�as que incluye');
if (!defined('_DOWN_SEARCH_FILES')) DEFINE ('_DOWN_SEARCH_FILES', 'Buscar archivo... ');

// Additions in 3.51
if (!defined('_DOWN_NOT_ABSOLUTE')) DEFINE ('_DOWN_NOT_ABSOLUTE', 'Ruta absoluta no v�lida');
...
if (!defined('_DOWN_NEW_UPDATED_MSG')) DEFINE ('_DOWN_NEW_UPDATED_MSG',
					"En %s un archivo ha sido a�adido o actualizado. El t�tulo del archivo es %s. El nombre del archivo es %s."
					."\n\nPor favor, no responda a este mensaje, ya que se genera autom�ticamente y es s�lo con fines informativos\n"
					);
if (!defined('_DOWN_NEW_COMMENT_MSG')) DEFINE ('_DOWN_NEW_COMMENT_MSG',
					"En %s un nuevo comentario ha sido hecho acerca del arhcivo.  El t�tulo del archivo es %s.  "
...
if (!defined('_DOWN_MAIL_MSG')) DEFINE('_DOWN_MAIL_MSG','Hola, un archivo para Descargar ha sido subido por %s'
                   ." para el Sitio Web %s.\n"
                   ."Por favor, inicie sesi�n como administrador para ver y aprobar la presente comunicaci�n.\n\n"
                   ."Por favor no responda a este mensaje, ya que se genera autom�ticamente y es s�lo con fines informativos\n");
if (!defined('_DOWN_MAIL_MSG_APP')) DEFINE('_DOWN_MAIL_MSG_APP','Hola, un archivo para Descargar ha sido subido por %s'
                   ." para el Sitio Web %s.\n"
                   ."De acuerdo con las opciones de configuraci�n, se ha auto-aprovado.\n\n"
                   ."Por favor no responda a este mensaje, ya que se genera autom�ticamente y es s�lo con fines informativos\n");
...
if (!defined('_DOWN_CONFIG70')) DEFINE ('_DOWN_CONFIG70', '<b>Mostrar ruta de la categor�a: </b><br /><em>(en los resultados de b�squeda, se mostrar� la ruta del contenedor completa)</em>');
if (!defined('_DOWN_CONFIG69')) DEFINE ('_DOWN_CONFIG69', '<b>Formato de fecha: </b><br /><em>(Elija una configuraci�n regional para el manejo de la fecha)</em>');
if (!defined('_DOWN_CONFIG68')) DEFINE ('_DOWN_CONFIG68', '<b>Forzar Lenguaje: </b><br /><em>(Fuerza el c�digo de idioma para este valor, ignorar la CMS)</em>');

// Additions in 3.47 to fix missed items in earlier versions
if (!defined('_DOWN_NO_FILE_RECEIVED')) DEFINE ('_DOWN_NO_FILE_RECEIVED', 'A pesar de que intent� subir un archivo, no se recibi� ninguno.');
if (!defined('_DOWN_SAMPLE')) DEFINE ('_DOWN_SAMPLE', 'Muestra');
if (!defined('_DOWN_SAMPLE_DESCRIPTION')) DEFINE ('_DOWN_SAMPLE_DESCRIPTION', 'Reemplazar o modificar este contendor de muestra seg�n sea necesario');
...
if (!defined('_DOWN_INSTALL_DONE2')) DEFINE ('_DOWN_INSTALL_DONE2', 'Puede encontrar m�s informaci�n en el <a href="http://remository.com">sitio web de Remository</a>.');
...
if (!defined('_DOWN_INSTALL_DONE4')) DEFINE ('_DOWN_INSTALL_DONE4', 'Desarrollar y mantener Remository lleva mucho tiempo y una cierta cantidad de'
		.' dinero para proporcionar el entorno de desarrollo. Si est� obteniendo beneficio econ�mico '
		.' de su uso de Remository, por favor considere hacer una donaci�n para apoyar al proyecto.'
		.' Haga clic en el bot�n a continuaci�n para efectuar un pago inmediato:');
...
if (!defined('_DOWN_NOT_YET_IMPLEMENTED')) DEFINE ('_DOWN_NOT_YET_IMPLEMENTED', 'ESTA FUNCIONALIDAD A�N NO HA SIDO IMPLEMENTADA	');
if (!defined('_DOWN_ADMIN_CPANEL_CACHEPATH')) DEFINE ('_DOWN_ADMIN_CPANEL_CACHEPATH', 'Ruta a la cach� del CMS - importante para las RSS y el control de acceso:');
if (!defined('_DOWN_CONFIG_EXPLAIN_4')) DEFINE ('_DOWN_CONFIG_EXPLAIN_4', 'D = Campos que se mostrar�n en la p�gina de informaci�n detallada, del archivo');
if (!defined('_DOWN_CONFIG67')) DEFINE ('_DOWN_CONFIG67', '<b>Perfil URI:</b> <br /><em>(URI no-SEF relativa al perfil con %u donde la ID de usuario deber�a estar)</em>');
if (!defined('_DOWN_CONFIG66')) DEFINE ('_DOWN_CONFIG66', '<b>Activar AEC:</b> <br /><em>(Activar integraci�n con AEC para el control de acceso)</em>');
if (!defined('_DOWN_AEC_OPTION_A')) DEFINE ('_DOWN_AEC_OPTION_A', 'Aplicar solo al grupo (o a los grupos) a continuaci�n.');
if (!defined('_DOWN_AEC_OPTION_B')) DEFINE ('_DOWN_AEC_OPTION_B', 'Borrar TODO, y a continuaci�n aplicar siguiente(s) grupo(s).');
if (!defined('_DOWN_AEC_OPTION_C')) DEFINE ('_DOWN_AEC_OPTION_C', 'Borrar grupo establecido en la aplicaci�n, y a continuaci�n aplicar el (los) grupo(s) siguientes:.');
if (!defined('_DOWN_CONFIG65')) DEFINE ('_DOWN_CONFIG65', '<b>T�tulo de la p�gina principal:</b><br /><em>(Entrada de la barra de t�tulo del navegador para la p�gina principal del repositorio)</em>');
...
if (!defined('_DOWN_OVERVIEW_LATEST')) DEFINE ('_DOWN_OVERVIEW_LATEST', '�ltimos archivos en el repositorio');
if (!defined('_DOWN_SPECIFY_AUTHOR')) DEFINE ('_DOWN_SPECIFY_AUTHOR', 'Otro autor');
if (!defined('_DOWN_CONFIG64')) DEFINE ('_DOWN_CONFIG64', '<b>Umbral de autores:</b><br /><em>(Listados de autor m�nimos a incluir en la lista desplegable)</em>');
...
if (!defined('_DOWN_CONFIG62')) DEFINE ('_DOWN_CONFIG62', '<b>Longitud de comentarios:</b><br /><em>(Longitud m�nima para un comentario de un archivo, o ignorarlo)</em>');
if (!defined('_DOWN_CONFIG61')) DEFINE ('_DOWN_CONFIG61', '<b>Descargar Video:</b><br /><em>(Permitir la descarga de archivos de v�deo)</em>');
...
if (!defined('_DOWN_CONFIG57')) DEFINE ('_DOWN_CONFIG57', '<b>Extensiones de archivos de v�deo:</b><br /><em>(Archivos de v�deo que ser�n reproducidos, no descargados)</em>');
if (!defined('_DOWN_CONFIG56')) DEFINE ('_DOWN_CONFIG56', '<b>Extensiones de archivos de audio:</b><br /><em>(Archivos de audio que ser�n reproducidos, no descargados)</em>');
...
if (!defined('_DOWN_FEATURE_END')) DEFINE ('_DOWN_FEATURE_END', 'Fecha de finalizaci�n (en blanco = para siempre)');
...
if (!defined('_DOWN_FIELD_TITLE')) DEFINE ('_DOWN_FIELD_TITLE', 'T�tulo del campo');
...
if (!defined('_DOWN_CUSTOM_INFO_PAGE')) DEFINE ('_DOWN_CUSTOM_INFO_PAGE', 'En la p�gina de informaci�n');
if (!defined('_DOWN_FIELD_OPTIONS')) DEFINE ('_DOWN_FIELD_OPTIONS', 'Limitar valores a los de esta lista (sep. por comas)');
if (!defined('_DOWN_CUSTOM_INFO')) DEFINE ('_DOWN_CUSTOM_INFO', 'El nombre del campo ser� usado en la base de datos y debe ser �nico para la tabla xxx_downloads_files.  El t�tulo del campo ser� usado para etiquetarlo cuando sea usado.');
if (!defined('_DOWN_CUSTOM_FIELDS_TAB')) DEFINE ('_DOWN_CUSTOM_FIELDS_TAB', 'A�adir campos');
if (!defined('_DOWN_CUSTOM_FIELDS_HEAD')) DEFINE ('_DOWN_CUSTOM_FIELDS_HEAD', 'Campos personalizados');
if (!defined('_DOWN_CONFIG55')) DEFINE ('_DOWN_CONFIG55', '<b>Elementos destacados:</b><br /><em>(N�mero de elementos a ser destacados)</em>');
...
if (!defined('_DOWN_DESCRIPTION')) DEFINE ('_DOWN_DESCRIPTION', 'Descripci�n');
...
if (!defined('_DOWN_CLASSIFICATION_NAME')) DEFINE ('_DOWN_CLASSIFICATION_NAME', 'Nombre de la clasificaci�n');
...
if (!defined('_DOWN_ADD')) DEFINE ('_DOWN_ADD', 'A�adir');
...
if (!defined('_DOWN_ADD_USERS_NEW_ROLE')) DEFINE ('_DOWN_ADD_USERS_NEW_ROLE', 'A�adir usuarios al nuevo rol');
if (!defined('_DOWN_ADD_MEMBERS')) DEFINE ('_DOWN_ADD_MEMBERS', 'A�adir miembros');
if (!defined('_DOWN_ADD_LOCAL')) DEFINE ('_DOWN_ADD_LOCAL', 'A�adir local');
if (!defined('_DOWN_ADD_REMOTE')) DEFINE ('_DOWN_ADD_REMOTE', 'A�adir remoto');
if (!defined('_DOWN_EDIT_APPROVAL')) DEFINE ('_DOWN_EDIT_APPROVAL', 'Editar aprobaci�n');
if (!defined('_DOWN_DELETE_SUBMISSION')) DEFINE ('_DOWN_DELETE_SUBMISSION', 'Borrar env�o');
...
if (!defined('_DOWN_DELETE_ORPHANS')) DEFINE ('_DOWN_DELETE_ORPHANS', 'Borrar hu�rfanos');
if (!defined('_DOWN_ORPHAN')) DEFINE ('_DOWN_ORPHAN', 'Hu�rfano');
if (!defined('_DOWN_MISSING')) DEFINE ('_DOWN_MISSING', 'Falta');
if (!defined('_DOWN_ADD_USERS_ROLE')) DEFINE ('_DOWN_ADD_USERS_ROLE', 'A�adir usuarios al rol');
...
if (!defined('_DOWN_PHYSICAL_FILE')) DEFINE ('_DOWN_PHYSICAL_FILE', 'Archivo f�sico');
if (!defined('_DOWN_METADATA')) DEFINE ('_DOWN_METADATA', 'Metadatos');
if (!defined('_DOWN_SHORT_DESCRIPTION')) DEFINE ('_DOWN_SHORT_DESCRIPTION', 'Descripci�n corta');
...
if (!defined('_DOWN_ADD_NEW_ROLE')) DEFINE ('_DOWN_ADD_NEW_ROLE', 'A�adir nuevo rol:');
...
if (!defined('_DOWN_SUBS_COUNT_DOWNLOAD')) DEFINE ('_DOWN_SUBS_COUNT_DOWNLOAD', 'Contar las decargas de un contenedor espec�fico');
if (!defined('_DOWN_SUBS_COUNT_UPLOAD')) DEFINE ('_DOWN_SUBS_COUNT_UPLOAD', 'Contar las subidas a un contenedor espec�fico');
...
if (!defined('_DOWN_CONFIG52')) DEFINE ('_DOWN_CONFIG52', '<b>Mostrar pie:</b><br /><em>(Mostrar el pie de Remository (Buscar/Enviar/Cr�ditos))</em>');
if (!defined('_DOWN_CONFIG51')) DEFINE ('_DOWN_CONFIG51', '<b>Informaci�n detallada:</b><br /><em>(Enlace a informaci�n detallada del archivo desde la lista de archivos)</em>');
...
if (!defined('_DOWN_REPOSITORY_NUMBER')) DEFINE ('_DOWN_REPOSITORY_NUMBER', 'N�mero del repositorio');
if (!defined('_DOWN_REPOSITORY_ALIAS')) DEFINE ('_DOWN_REPOSITORY_ALIAS', 'Alias del repositorio');
// Recent additions 3.46
if (!defined('_DOWN_SUBTITLE')) DEFINE ('_DOWN_SUBTITLE', 'Subt�tulo del archivo:');
if (!defined('_DOWN_PUBLISHER_ID')) DEFINE ('_DOWN_PUBLISHER_ID', 'ID del publicador:');
if (!defined('_DOWN_PUBLISHED_DATE')) DEFINE ('_DOWN_PUBLISHED_DATE', 'Fecha de publicaci�n:');
...
if (!defined('_DOWN_NO_FILTERS')) DEFINE ('_DOWN_NO_FILTERS', 'Ning�n filtro activo - todos los �tems mostrados');
if (!defined('_DOWN_REVIEW_TAGS')) DEFINE ('_DOWN_REVIEW_TAGS', 'Revisar etiquetas en el grupo');
if (!defined('_DOWN_NO_RESULTS_1')) DEFINE ('_DOWN_NO_RESULTS_1', 'Disculpe, su b�squeda no devolvi� ning�n resultado.');
if (!defined('_DOWN_NO_RESULTS_2')) DEFINE ('_DOWN_NO_RESULTS_2', '�No puede encontrar lo que busca?');
if (!defined('_DOWN_CONTACT_US')) DEFINE ('_DOWN_CONTACT_US', 'Contacte con nosotos y d�ganos qu� es lo que busca.');
if (!defined('_DOWN_ALL_CATS_RETRY')) DEFINE ('_DOWN_ALL_CATS_RETRY', '�Volver a intentar esta b�squeda con todas las categor�as seleccionadas?');
if (!defined('_DOWN_ADD_ALL_CATS')) DEFINE ('_DOWN_ADD_ALL_CATS', 'A�adir todas las categor�as');
if (!defined('_DOWN_CONFIG49')) DEFINE ('_DOWN_CONFIG49', '<b>Tipos de clasificaci�n:</b><br /><em>(valores separados por comas)</em>');
...
if (!defined('_DOWN_AEC_REFUSED')) DEFINE ('_DOWN_AEC_REFUSED', 'Seg�n AEC su l�mite de descargas ha sido alcanzado');
// Recent additions 3.44
if (!defined('_DOWN_FIELD')) DEFINE ('_DOWN_FIELD', 'Campo');
if (!defined('_DOWN_SEQUENCE')) DEFINE ('_DOWN_SEQUENCE', 'Posici�n');
if (!defined('_DOWN_CONFIG_EXPLAIN_1')) DEFINE ('_DOWN_CONFIG_EXPLAIN_1', 'A = Campos que se mostrar�n en la lista de archivos de una carpeta');
if (!defined('_DOWN_CONFIG_EXPLAIN_2')) DEFINE ('_DOWN_CONFIG_EXPLAIN_2', 'B = Campos que se mostrar�n en los resultados de las b�squedas');
if (!defined('_DOWN_CONFIG_EXPLAIN_3')) DEFINE ('_DOWN_CONFIG_EXPLAIN_3', 'C = Campos que se mostrar�n en los resultados de la subida de m�ltiples archivos');
// Recent additions 3.43:
if (!defined('_DOWN_ADDFILE_THUMBNAIL')) DEFINE ('_DOWN_ADDFILE_THUMBNAIL', 'Miniatura %u (opcional):');
if (!defined('_DOWN_CONFIG45')) DEFINE("_DOWN_CONFIG45","Licencia por defecto:<br/><i>(Opcional - si se define se usar� para cualquier elemento que no tenga una espec�fica)</i>");
...
if (!defined('_DOWN_STRUCT_RECURSE_NONE')) DEFINE('_DOWN_STRUCT_RECURSE_NONE','Incluir s�lo los ficheros del nivel superior');
...
if (!defined('_DOWN_ADMIN_ACT_ADDSTRUCTURE')) DEFINE('_DOWN_ADMIN_ACT_ADDSTRUCTURE','A�adir archivos que ya est�n en el servidor');
if (!defined('_DOWN_STRUCTURE_ADDED')) DEFINE('_DOWN_STRUCTURE_ADDED','Archivos a�adidos al repositorio');
if (!defined('_DOWN_ADDSTRUCTURE_TITLE')) DEFINE('_DOWN_ADDSTRUCTURE_TITLE','A�adir archivos que ya est�n en el servidor');
//
...
if (!defined('_DOWN_PAGE_TEXT')) DEFINE ('_DOWN_PAGE_TEXT', 'P�gina');
...
if (!defined('_SUBMIT_FILE_NOLOG')) DEFINE('_SUBMIT_FILE_NOLOG', 'Env�o denegado - no est�s logueado');
if (!defined('_SUBMIT_FILE_NOUSER')) DEFINE('_SUBMIT_FILE_NOUSER', 'Env�o denegado - s�lo administradores');
if (!defined('_SUBMIT_FILE_NOLIMIT')) DEFINE('_SUBMIT_FILE_NOLIMIT', 'Env�o denegado - lleg� al l�mite');
if (!defined('_SUBMIT_FILE_NOSPACE')) DEFINE('_SUBMIT_FILE_NOSPACE', 'Env�o denegado - no queda espacio');
if (!defined('_SUBMIT_NO_DDIR')) DEFINE('_SUBMIT_NO_DDIR', 'Env�o denegado - no hay directorio de descarga');
if (!defined('_SUBMIT_NO_UDDIR')) DEFINE('_SUBMIT_NO_UDDIR', 'Env�o denegado - no hay directorio de subida-bajada');
if (!defined('_SUBMIT_HEADING')) DEFINE('_SUBMIT_HEADING', 'Subir archivo a Descargas');
if (!defined('_SUBMIT_INSTRUCT1')) DEFINE('_SUBMIT_INSTRUCT1', 'Para subir un archivo nuevo, b�squelo y selecci�nelo aqu�.');
...
if (!defined('_DOWN_FILE_SUBMIT_NOCHOICES')) DEFINE('_DOWN_FILE_SUBMIT_NOCHOICES','No tiene permisos para subir archivos a ninguna categor�a - contacte con el administrador');
...
if (!defined('_MAIN_DOWNLOADS')) DEFINE('_MAIN_DOWNLOADS','P�gina Principal de Descargas');
if (!defined('_BACK_CAT')) DEFINE('_BACK_CAT','Regresar a la Categor�a Original');
if (!defined('_BACK_FOLDER')) DEFINE('_BACK_FOLDER','Regresar a la Carpeta Original');
if (!defined('_DOWN_START')) DEFINE('_DOWN_START','Su descarga comenzar� en 2 segundos.');
if (!defined('_DOWN_CLICK')) DEFINE('_DOWN_CLICK','Haga clic aqu� si no comienza.');
if (!defined('_INVALID_ID')) DEFINE('_INVALID_ID','ID inv�lido');
if (!defined('_DOWN_CATEGORY')) DEFINE('_DOWN_CATEGORY','Categor�a');
if (!defined('_DOWN_NO_PARENT')) DEFINE('_DOWN_NO_PARENT','Sin categor�a padre - nivel superior **');
...
if (!defined('_DOWN_NO_CATS')) DEFINE("_DOWN_NO_CATS","El directorio descargas no ha sido establecido para <i>$mosConfig_sitename</i>.<br/>&nbsp;<br/>Sin categor�as definidas .");
if (!defined('_DOWN_NO_VISITOR_CATS')) DEFINE('_DOWN_NO_VISITOR_CATS','El repositorio no est� disponible para visitantes - Por favor, inicie sesi�n');
...
if (!defined('_DOWN_DEL_CAT')) DEFINE('_DOWN_DEL_CAT','Eliminar Categor�a');
...
if (!defined('_DOWN_UP_DOWNLOAD_ONLY')) DEFINE('_DOWN_UP_DOWNLOAD_ONLY','S�lo Descargas');
if (!defined('_DOWN_UP_UPLOAD_ONLY')) DEFINE('_DOWN_UP_UPLOAD_ONLY','S�lo Subidas');
...
if (!defined('_DOWN_SUBMIT_INSPECT')) DEFINE('_DOWN_SUBMIT_INSPECT','�Ver el archivo reci�n enviado?');
if (!defined('_YES')) DEFINE('_YES','S�');
if (!defined('_NO')) DEFINE('_NO','No');
if (!defined('_GLOBAL')) DEFINE('_GLOBAL','Global');
if (!defined('_DOWN_DESC')) DEFINE('_DOWN_DESC','Descripci�n:');
...
if (!defined('_DOWN_FILE_TITLE')) DEFINE('_DOWN_FILE_TITLE','T�tulo del archivo:');
if (!defined('_DOWN_FILE_TITLE_SORT')) DEFINE('_DOWN_FILE_TITLE_SORT','T�tulo archivo');
if (!defined('_DOWN_REAL_NAME')) DEFINE('_DOWN_REAL_NAME','Nombre f�sico del archivo:');
...
if (!defined('_DOWN_FILE_VER')) DEFINE('_DOWN_FILE_VER','Versi�n del archivo:');
if (!defined('_DOWN_FILE_SIZE')) DEFINE('_DOWN_FILE_SIZE','Tama�o del archivo:');
...
if (!defined('_DOWN_FILE_COMPANY_URL')) DEFINE('_DOWN_FILE_COMPANY_URL','Sitio Web de la compa��a:');
...
if (!defined('_DOWN_NOT_AUTH')) DEFINE('_DOWN_NOT_AUTH','Sin Autorizaci�n!');
if (!defined('_DOWN_FOLDER_NAME')) DEFINE('_DOWN_FOLDER_NAME','Nombre carpeta:');
if (!defined('_DOWN_FOLDER_ADD_BUT')) DEFINE('_DOWN_FOLDER_ADD_BUT','A�adir carpeta');
if (!defined('_DOWN_UP_WAIT')) DEFINE('_DOWN_UP_WAIT','Nota: todos los env�os se revisan antes de publicarlos.');
if (!defined('_DOWN_AUTOAPP')) DEFINE('_DOWN_AUTOAPP','Su archivo fue autom�ticamente aprobado y publicado.');
if (!defined('_DOWN_APPROVE_PUB')) DEFINE('_DOWN_APPROVE_PUB','Aprobar + publicar');
if (!defined('_DOWN_SUGGEST_LOC')) DEFINE('_DOWN_SUGGEST_LOC','Sugerir ubicaci�n:');
...
if (!defined('_DOWN_FILE_NEW_LOC')) DEFINE('_DOWN_FILE_NEW_LOC','Nueva ubicaci�n del archivo:');
if (!defined('_DOWN_AWAIT_APPROVE')) DEFINE('_DOWN_AWAIT_APPROVE','Archivos enviados en espera de aprobaci�n:');
if (!defined('_DOWN_ADMIN_APPROVE')) DEFINE('_DOWN_ADMIN_APPROVE','Aprobar enviados');
if (!defined('_DOWN_ID')) DEFINE('_DOWN_ID','ID');
if (!defined('_DOWN_SUBMIT_DATE')) DEFINE('_DOWN_SUBMIT_DATE','Fecha de env�o:');
...
if (!defined('_DOWN_SUB_APPROVE')) DEFINE('_DOWN_SUB_APPROVE','El env�o ha sido aprobado.');
if (!defined('_DOWN_SUB_DEL')) DEFINE('_DOWN_SUB_DEL','El env�o ha sido borrado.');
if (!defined('_DOWN_NO_SUB')) DEFINE('_DOWN_NO_SUB','No hay m�s enviados para aprobar.');
if (!defined('_DOWN_REV_SUB')) DEFINE('_DOWN_REV_SUB','Revisar m�s enviados');
if (!defined('_DOWN_SEARCH')) DEFINE('_DOWN_SEARCH','Buscar descarga');
if (!defined('_DOWN_SEARCH_TEXT')) DEFINE('_DOWN_SEARCH_TEXT','Buscar:');
if (!defined('_DOWN_SEARCH_FILETITLE')) DEFINE('_DOWN_SEARCH_FILETITLE','Buscar en los t�tulos de los archivos:');
if (!defined('_DOWN_SEARCH_FILEDESC')) DEFINE('_DOWN_SEARCH_FILEDESC','Buscar en las descripciones de los archivos:');
if (!defined('_DOWN_SEARCH_ERR')) DEFINE('_DOWN_SEARCH_ERR','Tiene que especificar T�tulo o Descripci�n de archivo para buscar, tambi�n con texto.');
if (!defined('_DOWN_SEARCH_NORES')) DEFINE('_DOWN_SEARCH_NORES','No se han encontrado archivos.');
if (!defined('_DOWN_FILE_HOMEPAGE')) DEFINE('_DOWN_FILE_HOMEPAGE','P�ginas del documento:');
...
if (!defined('_DOWN_FILE_DEL_NOTE')) DEFINE('_DOWN_FILE_DEL_NOTE','Nota: el listado del archivo fu� eliminado de la base de datos, pero el archivo <b>puede</b> existir todav�a. Por favor revise su directorio');
if (!defined('_DOWN_SUB_DATE')) DEFINE('_DOWN_SUB_DATE','Enviado el:');
if (!defined('_DOWN_SUB_DATE_SORT')) DEFINE('_DOWN_SUB_DATE_SORT','Fecha de env�o');
if (!defined('_DOWN_SUB_ID_SORT')) DEFINE ('_DOWN_SUB_ID_SORT', 'Autor del env�o');
...
if (!defined('_DOWN_FIRST_COMMENT_NL')) DEFINE('_DOWN_FIRST_COMMENT_NL','Para ser el primero en comentar este archivo, ingrese o reg�strese.');
...
if (!defined('_DOWN_MAIL_MSG')) DEFINE('_DOWN_MAIL_MSG','Hola - Hay un nuevo archivo de Descargas para revisar, enviado por $user_full'
                   ...
                   .'Por favor vaya a $mosConfig_live_site/administrator/index.php como administrador para revisar y aprobar este env�o.\n\n'
                   .'Por favor no responder a este mensaje - es un e-mail generado autom�ticamente, s�lo para mandar una notificaci�n\n');
if (!defined('_DOWN_MAIL_MSG_APP')) DEFINE('_DOWN_MAIL_MSG_APP','Hola - Hay un nuevo archivo de Descargas para revisar, enviado por $user_full'
                   .' para el sitio $mosConfig_sitename\n'
                   .'De acuerdo con las opciones de la configuraci�n, ha sido auto-aprobado\n\n'
                   .'Por favor no responder a este mensaje - es un e-mail generado autom�ticamente, solo para mandar una notificaci�n\n');
...
if (!defined('_DOWN_RESET_DONE')) DEFINE('_DOWN_RESET_DONE','Rec�lculo de archivo terminado');
if (!defined('_DOWN_FIND_ORPHANS')) DEFINE('_DOWN_FIND_ORPHANS','Buscar archivos hu�rfanos');
if (!defined('_DOWN_DEL_ORPHANS')) DEFINE('_DOWN_DEL_ORPHANS','Borrar archivos hu�rfanos');
...
if (!defined('_DOWN_ORPHAN_DONE')) DEFINE('_DOWN_ORPHAN_DONE','Archivos hu�rfanos borrados');
if (!defined('_DOWN_BAD_POST')) DEFINE('_DOWN_BAD_POST','Los par�metros no han sido enviados correctamente.');
if (!defined('_DOWN_SUB_WAIT')) DEFINE('_DOWN_SUB_WAIT','Un env�o ya est� en revisi�n para este archivo.');
if (!defined('_DOWN_REG_ONLY')) DEFINE('_DOWN_REG_ONLY','S�lo usuarios registrados:');
if (!defined('_DOWN_RESTRICTED_WARN')) DEFINE('_DOWN_RESTRICTED_WARN','Este �rea no existe o no est� disponible');
if (!defined('_DOWN_MEMBER_ONLY_WARN')) DEFINE("_DOWN_MEMBER_ONLY_WARN","Este �rea es solamente para Usuarios Registrados.<BR />"
                            ."Por favor contacte con un administrador referente a este grupo ");
if (!defined('_DOWN_REG_ONLY_WARN')) DEFINE("_DOWN_REG_ONLY_WARN","Este �rea es solamente para Usuarios Registrados.<BR />"
                            ."Por favor, accede con tu cuenta o <a href='index.php?option=com_registration&task=register'>Reg�strate</a>.");
if (!defined('_DOWN_COUNT_EXCEEDED')) DEFINE('_DOWN_COUNT_EXCEEDED',"Su l�mite de descargas ha sido alcanzado");
if (!defined('_DOWN_COUNT_EXCEEDED_FILE')) DEFINE('_DOWN_COUNT_EXCEEDED_FILE',"Su l�mite de descargas de este archivo ha sido alcanzado");
if (!defined('_DOWN_NO_FILEN')) DEFINE('_DOWN_NO_FILEN','Por favor debe introducir un t�tulo para el archivo');
if (!defined('_DOWN_MINI_SCREEN_PROMPT')) DEFINE('_DOWN_MINI_SCREEN_PROMPT','Mostrar captura de pantalla:');
if (!defined('_DOWN_SEL_LOC_PROMPT')) DEFINE('_DOWN_SEL_LOC_PROMPT','Elegir ubicaci�n');
if (!defined('_DOWN_ALL_LOC_PROMPT')) DEFINE('_DOWN_ALL_LOC_PROMPT','Todas las ubicaciones');
if (!defined('_DOWN_SEL_CAT_DEL')) DEFINE('_DOWN_SEL_CAT_DEL','Elegir una categor�a para borrar');
if (!defined('_DOWN_NO_CAT_DEF')) DEFINE('_DOWN_NO_CAT_DEF','No hay categor�as definidas');
if (!defined('_DOWN_PUB_PROMPT')) DEFINE('_DOWN_PUB_PROMPT','Elegir una categor�a para ');
if (!defined('_DOWN_SEL_FILE_DEL')) DEFINE('_DOWN_SEL_FILE_DEL','Elegir un archivo para borrar');
if (!defined('_DOWN_CONFIG_COMP')) DEFINE('_DOWN_CONFIG_COMP','Los detalles de configuraci�n han sido actualizados.');
if (!defined('_DOWN_CONFIG_ERR')) DEFINE("_DOWN_CONFIG_ERR","Un error ha ocurrido.\nNo se pudo abrir el archivo de configuraci�n para escribir.");
if (!defined('_DOWN_CATS')) DEFINE('_DOWN_CATS','Categor�as');
if (!defined('_DOWN_PARENT_CAT')) DEFINE('_DOWN_PARENT_CAT','Categor�a Padre');
...
if (!defined('_DOWN_ADMIN_CPANEL_FILESTORE')) DEFINE ('_DOWN_ADMIN_CPANEL_FILESTORE','Almac�n por defecto en el sistema de archivos:');
...
if (!defined('_DOWN_CPANEL_SUB_BASIC')) DEFINE ('_DOWN_CPANEL_SUB_BASIC','Gesti�n b�sica');
if (!defined('_DOWN_CPANEL_SUB_FILES')) DEFINE ('_DOWN_CPANEL_SUB_FILES','Manipulaci�n de archivos');
...
if (!defined('_DOWN_ADMIN_ACT_UNLINKED')) DEFINE('_DOWN_ADMIN_ACT_UNLINKED','Gestionar no enlazados / hu�rfanos');
if (!defined('_DOWN_ADMIN_ACT_FTP')) DEFINE('_DOWN_ADMIN_ACT_FTP','A�adir archivos desde el servidor');
...
if (!defined('_DOWN_ADMIN_ACT_STATS')) DEFINE('_DOWN_ADMIN_ACT_STATS','Estad�sticas');
...
if (!defined('_DOWN_MOST_DOWNLOADED')) DEFINE('_DOWN_MOST_DOWNLOADED','M�s descargados');
if (!defined('_DOWN_MOST_DOWNLOADED_LONG')) DEFINE('_DOWN_MOST_DOWNLOADED_LONG','Archivos con mayor conteo de descargas');
if (!defined('_DOWN_POPULAR')) DEFINE ('_DOWN_POPULAR','Archivos m�s populares');
if (!defined('_DOWN_POPULAR_LONG')) DEFINE ('_DOWN_POPULAR_LONG','Archivos m�s descargados en los �ltimos %s d�as');
if (!defined('_DOWN_NEWEST')) DEFINE ('_DOWN_NEWEST','Archivos recientes');
if (!defined('_DOWN_NEWEST_LONG')) DEFINE ('_DOWN_NEWEST_LONG','Lo �ltimo de nuestro repositorio de archivos');
...
if (!defined('_DOWN_REG_ONLY_TITLE')) DEFINE('_DOWN_REG_ONLY_TITLE','S�lo registrados');
...
if (!defined('_DOWN_CONFIG_TITLE1')) DEFINE('_DOWN_CONFIG_TITLE1','Rutas y miscel�nea');
...
if (!defined('_DOWN_CONFIG_TITLE4')) DEFINE('_DOWN_CONFIG_TITLE4','Configurar p�ginas');
if (!defined('_DOWN_CONFIG_TITLE_PREAMBLE')) DEFINE('_DOWN_CONFIG_TITLE_PREAMBLE','Introducci�n');
...
if (!defined('_DOWN_CONFIG2')) DEFINE("_DOWN_CONFIG2","<b>Clases CSS para la cabecera:</b><br/><i>(Clase CSS de la cabecera de la p�gina y del fondo del panel del Administrador)</i>");
...
if (!defined('_DOWN_CONFIG6')) DEFINE("_DOWN_CONFIG6","<b>Tama�o m�ximo:</b><br/><i>(M�ximo tama�o para un archivos enviado - en Kb's)</i>");
if (!defined('_DOWN_CONFIG7')) DEFINE("_DOWN_CONFIG7","<b>M�ximos archivos enviados por d�a:</b><br/><i>(N�mero m�ximo permitido de archivos enviados al d�a por un usuario (Administradores ilimitado))</i>");
if (!defined('_DOWN_CONFIG8')) DEFINE("_DOWN_CONFIG8","<b>Tama�o m�ximo para archivos enviados: </b><br/><i>(Tama�o m�ximo del directorio de subidas aprobadas - en Kb's)</i>");
...
if (!defined('_DOWN_CONFIG12')) DEFINE("_DOWN_CONFIG12","<b>Permitir enviar archivos a los usuarios:</b><br/><i>(Permitir que los usuarios suban archivos - los archivos necesitar�n ser aprobados por el Administrador)</i>");
if (!defined('_DOWN_CONFIG13')) DEFINE("_DOWN_CONFIG13","<b>Permitir correcciones: </b><br/><i>(Permitir que los usuarios corrijan sus archivos enviados - los archivos necesitar�n ser Reaprobados por el Administrador)</i>");
if (!defined('_DOWN_CONFIG14')) DEFINE("_DOWN_CONFIG14","<b>Permitir env�os de archivos: </b><br/><i>(Permitir que los usuarios suban archivos - los archivos deben ser aprobados por el Administrador)</i>");
...
if (!defined('_DOWN_CONFIG17')) DEFINE("_DOWN_CONFIG17","<b>Direcci�n alternativar:</b><br/><i>(Direcci�n de email alternativa para enviar avisos de archivos enviados - si no se define se utilizar� el email del administrador del sitio)</i>");
if (!defined('_DOWN_CONFIG18')) DEFINE("_DOWN_CONFIG18","<b>T�tulo alternativo:</b><br/><i>(T�tulo alternativo para las notificaciones de subida)</i>");
if (!defined('_DOWN_CONFIG19')) DEFINE("_DOWN_CONFIG19","<b>Imagen para el encabezado:</b><br/><i>(Imagen del encabezado - URL)</i>");
if (!defined('_DOWN_CONFIG20')) DEFINE("_DOWN_CONFIG20","<b>Anti-Leach:</b><br/><i>(M�scara de archivos para prevenir el enlace directo)</i>");
if (!defined('_DOWN_CONFIG21')) DEFINE("_DOWN_CONFIG21","<b>Longitud de campos grandes:</b><br/><i>(M�xima longitud de los campos de texto grandes - Descripci�n, licencia))</i>");
if (!defined('_DOWN_CONFIG22')) DEFINE("_DOWN_CONFIG22","<b>Longitud de campos peque�os:</b><br/><i>(M�xima longitud de los campos de texto peque�os - Introducci�n, campo de texto)</i>");
if (!defined('_DOWN_CONFIG23')) DEFINE("_DOWN_CONFIG23","<b>Anchura de im�genes peque�as:</b><br/><i>(Ancho de las capturas de pantalla peque�as)</i>");
if (!defined('_DOWN_CONFIG24')) DEFINE("_DOWN_CONFIG24","<b>Altura de im�genes peque�as:</b><br/><i>(Alto de las capturas de pantalla peque�as)</i>");
...
if (!defined('_DOWN_CONFIG26')) DEFINE("_DOWN_CONFIG26","<b>Activar auto-publicaci�n para Administradores:</b><br/><i>(Permitir que los archivos subidos por un ADMINISTRADOR se aprueben y publiquen autom�ticamente)</i>");
if (!defined('_DOWN_CONFIG27')) DEFINE("_DOWN_CONFIG27","<b>Permitir auto-publicaci�n para usuarios:</b><br/><i>(Permitir que los archivos subidos por un USUARIO REGISTRADO que se aprueben y publiquen autom�ticamente)</i>");
...
if (!defined('_DOWN_CONFIG29')) DEFINE("_DOWN_CONFIG29","<b>Archivos remotos</b><br/><i>(Permitir que los usuarios env�en archivos remotamente:</b><br/><i>(Archivos que se encuentran en otras webs)</i>");
if (!defined('_DOWN_CONFIG30')) DEFINE("_DOWN_CONFIG30","<b>M�ximos archivos favoritos: </b><br/><i>(Permitir que los usuarios registren sus archivos favoritos)</i>");
if (!defined('_DOWN_CONFIG31')) DEFINE("_DOWN_CONFIG31","<b>Formato de fecha:</b><br/><i>(Ajuste el formato de las fechas de Descargas - par�metro 1 de la funci�n de la fecha de PHP)</i>");
if (!defined('_DOWN_CONFIG32')) DEFINE("_DOWN_CONFIG32","<b>Versi�n por defecto:</b><br/><i>(Valor prefijado para dar la versi�n del archivo enviado)</i>");
if (!defined('_DOWN_CONFIG33')) DEFINE('_DOWN_CONFIG33','<b>Permitir ver  categor�as sin permisos: </b><br/><i>(Permitir a los usuarios ver las categor�as/carpetas de las que no pueden descargar)</i>');
...
if (!defined('_DOWN_CONFIG35')) DEFINE('_DOWN_CONFIG35','<b>Miniaturas m�ximas:</b><br/><i>(N�mero m�ximo de miniaturas que se almacenar�n; 0 si s�lo se permite URL)</i>');
...
if (!defined('_DOWN_CONFIG40')) DEFINE("_DOWN_CONFIG40","<b>M�ximas descargas diarias:</b><br/><i>(N�mero m�ximo de descargas permitidas al d�a para un usuario - Administradores ilimitado)</i>");
if (!defined('_DOWN_CONFIG41')) DEFINE("_DOWN_CONFIG41","<b>M�ximas descargas diarias:</b><br/><i>(N�mero m�ximo de descargas de un mismo archivo permitidas al d�a para un usuario. Administradores ilimitado)</i>");
if (!defined('_DOWN_CONFIG42')) DEFINE("_DOWN_CONFIG42","<b>Permitir borrar archivos:</b><br/><i>(Permitir borrar un archivo al usuario que lo envi�)</i>");
if (!defined('_DOWN_CONFIG43')) DEFINE('_DOWN_CONFIG43','<b>Crear miniaturas de forma autom�tica:</b><br/><i>(Crear miniaturas autom�ticamente para los archivos de imagen)</i>');
if (!defined('_DOWN_CONFIG44')) DEFINE("_DOWN_CONFIG44","<b>M�ximas descargas diarias para un usuario registrado:</b><br/><i>(N�mero m�ximo de descargas permitidas al d�a para un usuario registrado - Administradores ilimitado)</i>");
if (!defined('_DOWN_STATS_TITLE')) DEFINE('_DOWN_STATS_TITLE','- Estad�sticas');
if (!defined('_DOWN_TOP_TITLE')) DEFINE('_DOWN_TOP_TITLE','Top');
if (!defined('_DOWN_RATED_TITLE')) DEFINE('_DOWN_RATED_TITLE','- M�s Valorados');
if (!defined('_DOWN_VOTED_ON')) DEFINE('_DOWN_VOTED_ON','- M�s votados');
...
if (!defined('_DOWN_AUTO_SHORT')) DEFINE('_DOWN_AUTO_SHORT','Autogenerar descripci�n breve:');
...
if (!defined('_DOWN_LEECH_WARN')) DEFINE('_DOWN_LEECH_WARN','Tu sesi�n no fue v�lida y las medidas de seguridad est�n vigentes.');
...
if (!defined('_DOWN_LICENSE_CHECKBOX')) DEFINE('_DOWN_LICENSE_CHECKBOX','Estoy de acuerdo con los t�rminos anteriores.');
...
if (!defined('_DOWN_EXTENSION_IN_TITLE')) DEFINE('_DOWN_EXTENSION_IN_TITLE','Extensi�n en el t�tulo');
if (!defined('_DOWN_INHERIT')) DEFINE('_DOWN_INHERIT','�Heredar�n la configuraci�n todas las subcarpetas por debajo de esta?');
...
if (!defined('_DOWN_EXT_IN_TITLE')) DEFINE('_DOWN_EXT_IN_TITLE','Extensi�n en el t�tulo');
if (!defined('_DOWN_BULK_ADD_FILES')) DEFINE('_DOWN_BULK_ADD_FILES','a�adir archivos desde el directorio de descargas');
...
if (!defined('_DOWN_EXTENSION_IN_TITLE')) DEFINE('_DOWN_EXTENSION_IN_TITLE','Extensi�n inclu�da en el t�tulo:');
if (!defined('_DOWN_DOWNLOAD_TEXT_BOX')) DEFINE('_DOWN_DOWNLOAD_TEXT_BOX','Cuadro de texto de descarga');
if (!defined('_DOWN_MAIN_PREAMBLE')) DEFINE('_DOWN_MAIN_PREAMBLE', 'Texto para la p�gina principal');
if (!defined('_DOWN_PRUNE_LOG')) DEFINE('_DOWN_PRUNE_LOG','Purgar el archivo de registro (logfile)');
if (!defined('_DOWN_LOGFILE_CUTOFF_DATE')) DEFINE('_DOWN_LOGFILE_CUTOFF_DATE','Las entradas del archivo de registro (logfile) anteriores a esta fecha ser�n borradas:');
if (!defined('_DOWN_PRESS_SAVE_ACTIVATE')) DEFINE('_DOWN_PRESS_SAVE_ACTIVATE','despu�s presione "Guardar" para activar.');
if (!defined('_DOWN_METHOD_NOT_PRESENT')) DEFINE('_DOWN_METHOD_NOT_PRESENT','Error %s en el componente: intento de usar el m�todo inexistente %s en %s');
...
if (!defined('_DOWN_PLAINTEXT_DISCREPANCY')) DEFINE('_DOWN_PLAINTEXT_DISCREPANCY',' - LA TABLA DE TEXTO PLANO TIENE %s ENTRADAS, DEBER�AN SER EXACTAMENTE 1');
if (!defined('_DOWN_NOT_FOUND_HERE')) DEFINE('_DOWN_NOT_FOUND_HERE',' - NO SE ENCONTR� EN ESTA LOCALIZACI�N<br/>');
if (!defined('_DOWN_LOCAL_NO_URL')) DEFINE('_DOWN_LOCAL_NO_URL','ARCHIVO REMOTO, PERO NO SE ESPECIFIC� URL');
if (!defined('_DOWN_NOT_VALID_BR')) DEFINE('_DOWN_NOT_VALID_BR',' - NO VALIDADO<br/>');
if (!defined('_DOWN_NO_RELEVANT_THUMB')) DEFINE('_DOWN_NO_RELEVANT_THUMB',' - no hay archivos relevantes - intento de eliminaci�n.<br/>');
if (!defined('_DOWN_THUMB_NOT_BELONG')) DEFINE('_DOWN_THUMB_NOT_BELONG','El archivo %s del directorio %s no se corresponde - intento de eliminaci�n.<br/>');
if (!defined('_DOWN_THUMB_NOT_IN_DB')) DEFINE('_DOWN_THUMB_NOT_IN_DB',' - no hay coincidencia en la base de datos - intento de eliminaci�n.<br/>');
if (!defined('_DOWN_THUMB_OK')) DEFINE('_DOWN_THUMB_OK','No se encontraron problemas con los archivos de miniaturas');
if (!defined('_DOWN_DB_CONVERT_OK')) DEFINE('_DOWN_DB_CONVERT_OK','Conversi�n de la base de datos completada. Los archivos listados arriba no eran v�lidos.');
...
if (!defined('_DOWN_CLICK_TO_VISIT')) DEFINE('_DOWN_CLICK_TO_VISIT','Hacer clic para visitar la p�gina');
...
if (!defined('_DOWN_WINDOW_TITLE')) DEFINE('_DOWN_WINDOW_TITLE','T�tulo de la ventana:');
if (!defined('_DOWN_EDITOR_GROUP')) DEFINE('_DOWN_EDITOR_GROUP','Grupo editor:');
if (!defined('_DOWN_AUTO_FOR_ADMIN')) DEFINE('_DOWN_AUTO_FOR_ADMIN','Auto-aprobar env�o de Administradores:');
...
if (!defined('_DOWN_WAIT_OR_CLICK')) DEFINE('_DOWN_WAIT_OR_CLICK','Si su descarga no comienza autom�ticamente en unos pocos segundos haga clic en el siguiente enlace');
...
if (!defined('_DOWN_COMMENT_NL')) DEFINE('_DOWN_COMMENT_NL','Acceda o reg�strese para hacer su propio comentario');

// Define some summaries for tables
if (!defined('_TABLE_SUMMARY_GENHEAD')) DEFINE ('_TABLE_SUMMARY_GENHEAD', 'Listado de las categor�as y el n�mero de archivos en cada una de ellas disponible.');
...
if (!defined('_ERR2')) DEFINE('_ERR2','Ataque de env�o de archivos');
if (!defined('_ERR3')) DEFINE('_ERR3','El archivo enviado no tiene ning�n tama�o; no tiene contenido.');
if (!defined('_ERR4')) DEFINE('_ERR4','El archivo enviado contiene una extensi�n o sufijo no permitido');
if (!defined('_ERR5')) DEFINE('_ERR5','El archivo enviado excede el tama�o m�ximo de ');
if (!defined('_ERR6')) DEFINE('_ERR6','El archivo enviado ya existe. Por favor especificar un nuevo t�tulo.');
if (!defined('_ERR7')) DEFINE('_ERR7','El espacio de Descargas est� actualmente lleno.');
if (!defined('_ERR8')) DEFINE('_ERR8','Tiene que ser un Administrador o Usuario Registrado para subir un archivo.');
if (!defined('_ERR9')) DEFINE('_ERR9','Has alcanzado tu l�mite diario de subida de archivos.');
if (!defined('_ERR10')) DEFINE('_ERR10','Enviar archivos por usuarios no est� permitido.');
if (!defined('_ERR11')) DEFINE('_ERR11','Fallo de env�o de archivo con c�digo ');
if (!defined('_UP_SUCCESS')) DEFINE('_UP_SUCCESS','El env�o del archivo ha sido exitoso.');
...
if (!defined('_MBT_GROUP_DESCRIPTION')) DEFINE('_MBT_GROUP_DESCRIPTION','Descripci�n');
if (!defined('_MBT_GROUP_EMAIL')) DEFINE('_MBT_GROUP_EMAIL','Enviar un email al grupo');
if (!defined('_MBT_GROUP_ADD')) DEFINE('_MBT_GROUP_ADD','A�adir grupo');
...
if (!defined('_MBT_GROUP_SEND_ADMIN')) DEFINE('_MBT_GROUP_SEND_ADMIN','S�lo los administradores tienen permiso para enviar emails');
