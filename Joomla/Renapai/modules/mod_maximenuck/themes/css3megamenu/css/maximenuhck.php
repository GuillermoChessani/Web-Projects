...
filter: none;
background: #0dc51e;
background: -moz-linear-gradient(top,  #61A60E 0%, #80BD01 100%);
background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,#61A60E), color-stop(100%,#80BD01));
background: -webkit-linear-gradient(top,  #61A60E 0%,#80BD01 100%);
background: -o-linear-gradient(top,  #61A60E 0%,#80BD01 100%);
background: -ms-linear-gradient(top,  #61A60E 0%,#80BD01 100%);
background: linear-gradient(top,  #61A60E 0%,#80BD01 100%);
border: 1px solid #61A60E;
-moz-box-shadow:inset 0px 0px 1px #61A60E;
-webkit-box-shadow:inset 0px 0px 1px #A3D65C;
box-shadow:inset 0px 0px 1px #61A60E;
text-align: left;
zoom: 1;
}
...
background: #A3D65C;
background: -moz-linear-gradient(top, #A3D65C, #C3E76A);
background: -webkit-gradient(linear, 0% 0%, 0% 100%, from(#A3D65C), to(#C3E76A));
